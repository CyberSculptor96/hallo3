...
# 定义文件路径
input_json_path = '/wangbenyou/shunian/workspace/talking_face/video_processing/video_filtering/sample_diverse_data/data_sampled.json'
...
for i in range(num_files):
    ...
    # 输出文件路径
    output_txt_path = f"{output_dir}input_testset_22-{i}.txt"
